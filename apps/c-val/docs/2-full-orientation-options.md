...
- `apps/c-val/socket/experiments/2/orientation.mjs`: quaternion, pose, path and
  V/A/L mapping;
- `components/c-val/2/mobile/index.tsx`: sensor sampling and transmission;
- `apps/c-val/socket/experiments/2/model.mjs`: unchanged market path consuming the
...
`apps/c-val/docs/2-working-baseline-2026-08-04.md`, including formulas,
