...
- **Current temporary state:** `ENABLE_MEDIA_COMMENT_REACTION` is `false`.
  The media screen therefore shows neither the reaction text nor its associated
  audio, while the complete layer remains in the codebase for restoration.
