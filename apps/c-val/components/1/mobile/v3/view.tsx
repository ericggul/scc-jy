...
} from "@/components/1/model";
import type {
  CValMobileAxisSignal,
  MotionPermission,
} from "@/components/1/mobile";
    ...
    <main className={styles.page}>
      <header className={styles.header}>
        <nav className={styles.versionNav} aria-label="Mobile interface version">
          <Link className={styles.versionLink} href="/1/mobile">V1</Link>
          <Link className={styles.versionLink} href="/1/mobile/v2">V2</Link>
