...
- `/0804/tube`: an isolated dark London Underground field experiment in
  which station positions are the swarm's persistent attraction targets.
- `/0804/pillars`: an independent copy of `default` whose selected-cell blocks
  rise into independently randomized symmetric pillars while preserving the
  exact-top initial view.
- `/0806/side-view`: an independent Pillars fork that starts and
...
`apps/goldfishes/public/assets/goldfishes/assets/company-logos`.
...
- `apps/goldfishes/public/assets/goldfishes/goldfish-eye-collage-circle-75-svg`
- `apps/goldfishes/public/assets/goldfishes/goldfish-eye-collage-rect-75-svg`
...
`/2d/1`, `/default`, `/0804/tube`, `/0804/pillars`, and `/0806/side-view` each define their own
