...
import { playMeditationSoundtrack, scheduleMeditationSoundtrackStop, stopMeditationSoundtrack } from "@/components/3/mobile copy/media";
import type { ReadingLine } from "@/components/3/model/reading-script";
...
function TimerHeader({
  ...
  return (
    <header className={styles.header}>
      <Link className={styles.wordmark} href="/3/main">
        ddong-meong
      </Link>
      {showTimeBar ? (
        <>
