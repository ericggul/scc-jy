...
import DdongMeongOneDummy from "@/components/1/contents/dummy";
import {
...
} from "@/components/1/contents/guided-reading";
import {
  meditationContents as oneMeditationContents,
  type MeditationContentSlug as OneMeditationContentSlug,
} from "@/components/1/model/content-catalog";
import DdongMeongTwoDummy from "@/components/2/contents/dummy";
import {
...
} from "@/components/2/contents/guided-reading";
import {
  meditationContents as twoMeditationContents,
  type MeditationContentSlug as TwoMeditationContentSlug,
} from "@/components/2/model/content-catalog";
import DdongMeongThreeContent from "@/components/3/mobile/content";
import { mobileMeditationContents as threeMeditationContents } from "@/components/3/mobile/content/registry";
import DdongMeongFourContent from "@/components/4/mobile/content";
import { mobileMeditationContents as fourMeditationContents } from "@/components/4/mobile/content/registry";
