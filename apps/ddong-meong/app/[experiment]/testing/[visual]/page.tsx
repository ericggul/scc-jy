...
import DdongMeongThreeBackgroundLab from "@/components/3/testing/interactive-background-lab";
import {
  backgroundExperiments as threeBackgroundExperiments,
  findBackgroundExperiment as findThreeBackgroundExperiment,
} from "@/components/3/testing/interactive-background-lab/registry";
import DdongMeongFourBackgroundLab from "@/components/4/testing/interactive-background-lab";
import {
  backgroundExperiments as fourBackgroundExperiments,
  findBackgroundExperiment as findFourBackgroundExperiment,
} from "@/components/4/testing/interactive-background-lab/registry";
