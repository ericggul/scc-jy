...
const events = {
  join: "ddong-meong:1:join",
  hello: "ddong-meong:1:hello",
  state: "ddong-meong:1:state",
  sessionIn: "ddong-meong:1:session:in",
};
...
export const ddongMeongOneExperiment = {
  id,
  events,
  register,
};
