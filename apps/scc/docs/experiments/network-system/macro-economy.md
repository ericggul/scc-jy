...
6. `apps/scc/socket/experiments/network-system/macro-economy/model.mjs` owns the continuously running server-side dynamics and applies interventions.
7. `apps/scc/socket/experiments/network-system/macro-economy/index.mjs` owns the clock, room, intervention validation, and state broadcast.
...
This case is governed by the repository-wide rules in
`docs/foundations/design-guidelines.md`.
...
- `apps/scc/socket/experiments/network-system/macro-economy/index.mjs`
- `apps/scc/socket/experiments/network-system/macro-economy/model.mjs`
