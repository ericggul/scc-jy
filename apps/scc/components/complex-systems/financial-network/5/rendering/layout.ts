...
/**
 * Fixed, semantic positions: a household stays beside its original community
 * employer. Payment counterparts can rewire in the model, while positions stay
 * stable so a changed curve reads as a changed economic relation, not drift.
 */
