...
import styles from "../central-limit.module.css";
import CentralLimitSurface from "../rendering/central-limit-surface";

type ParameterKey = keyof CentralLimitParameters;
...
export default function CentralLimitScreen() {
  const [parameters, setParameters] = useState(DEFAULT_CENTRAL_LIMIT_PARAMETERS);
  ...
  return (
    <section
      aria-label="A central-limit particle field for a bivariate normal distribution"
        ...
        <div className={styles.actions}>
          ...
          <button
            ...
            onClick={(event) => {
              ...
              setParameters(DEFAULT_CENTRAL_LIMIT_PARAMETERS);
              redraw();
            }}
            type="reset"
          >
