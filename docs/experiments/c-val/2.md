...
The V2 controller uses the information grammar of a professional market
workstation without copying Bloomberg branding or inventing terminal
...
are preservation requirements for the C-VAL 2 controller:
