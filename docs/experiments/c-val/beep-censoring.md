...
/opt/homebrew/Caskroom/miniconda/base/bin/python \
  scripts/extract-c-val-profanity-timestamps.py
```
...
`scripts/collections/c-val-profanity-timestamp-overrides.json`, which records
...
```sh
node scripts/censor-c-val-profanity.mjs \
