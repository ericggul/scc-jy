...
- **Trial 3 — flat CSS 5 × 3 grid, rejected and assessed as regression:** copied
  ...
  geometry checklist.
- **Trial 4 — current asset-backed chassis:** a new original machine asset was
...
- **Changed variable:** one additional standalone surrounding-price
  representation at `/c-val/2/screen/casino`, now with a participant-controlled
