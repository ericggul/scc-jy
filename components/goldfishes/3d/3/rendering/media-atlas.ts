...
const COMPANY_LOGOS: readonly CompanyLogo[] = [
  { kind: "asset", src: "/goldfishes/3d/3/logos/openai.svg" },
  { kind: "icon", icon: siAnthropic },
  { kind: "asset", src: "/goldfishes/3d/3/logos/sk-hynix.svg" },
  { kind: "icon", icon: siMeta },
  { kind: "asset", src: "/goldfishes/3d/3/logos/amazon.svg" },
  { kind: "icon", icon: siApple },
  { kind: "icon", icon: siNetflix },
  { kind: "icon", icon: siGoogle },
  { kind: "asset", src: "/goldfishes/3d/3/logos/microsoft.svg" },
  { kind: "icon", icon: siNvidia },
  { kind: "icon", icon: siSamsung },
  { kind: "asset", src: "/goldfishes/3d/3/logos/tsmc.svg" },
  { kind: "asset", src: "/goldfishes/3d/3/logos/asml.svg" },
  ...
  { kind: "asset", src: "/goldfishes/3d/3/logos/oracle.svg" },
  { kind: "asset", src: "/goldfishes/3d/3/logos/salesforce.svg" },
  { kind: "asset", src: "/goldfishes/3d/3/logos/adobe.svg" },
  { kind: "asset", src: "/goldfishes/3d/3/logos/ibm.svg" },
  { kind: "asset", src: "/goldfishes/3d/3/logos/micron.svg" },
  { kind: "asset", src: "/goldfishes/3d/3/logos/servicenow.svg" },
