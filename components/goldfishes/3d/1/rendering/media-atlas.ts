...
const COMPANY_LOGOS: readonly CompanyLogo[] = [
  { kind: "asset", src: "/goldfishes/3d/1/logos/openai.svg" },
  { kind: "icon", icon: siAnthropic },
  { kind: "asset", src: "/goldfishes/3d/1/logos/sk-hynix.svg" },
  { kind: "icon", icon: siMeta },
  { kind: "asset", src: "/goldfishes/3d/1/logos/amazon.svg" },
  { kind: "icon", icon: siApple },
  { kind: "icon", icon: siNetflix },
  { kind: "icon", icon: siGoogle },
  { kind: "asset", src: "/goldfishes/3d/1/logos/microsoft.svg" },
  { kind: "icon", icon: siNvidia },
  { kind: "icon", icon: siSamsung },
  { kind: "asset", src: "/goldfishes/3d/1/logos/tsmc.svg" },
  { kind: "asset", src: "/goldfishes/3d/1/logos/asml.svg" },
  ...
  { kind: "asset", src: "/goldfishes/3d/1/logos/oracle.svg" },
  { kind: "asset", src: "/goldfishes/3d/1/logos/salesforce.svg" },
  { kind: "asset", src: "/goldfishes/3d/1/logos/adobe.svg" },
  { kind: "asset", src: "/goldfishes/3d/1/logos/ibm.svg" },
  { kind: "asset", src: "/goldfishes/3d/1/logos/micron.svg" },
  { kind: "asset", src: "/goldfishes/3d/1/logos/servicenow.svg" },
