...
const COMPANY_LOGOS: readonly CompanyLogo[] = [
  { kind: "asset", src: "/goldfishes/assets/company-logos/openai.svg" },
  { kind: "icon", icon: siAnthropic },
  { kind: "asset", src: "/goldfishes/assets/company-logos/sk-hynix.svg" },
  { kind: "icon", icon: siMeta },
  { kind: "asset", src: "/goldfishes/assets/company-logos/amazon.svg" },
  { kind: "icon", icon: siApple },
  { kind: "icon", icon: siNetflix },
  { kind: "icon", icon: siGoogle },
  { kind: "asset", src: "/goldfishes/assets/company-logos/microsoft.svg" },
  { kind: "icon", icon: siNvidia },
  { kind: "icon", icon: siSamsung },
  { kind: "asset", src: "/goldfishes/assets/company-logos/tsmc.svg" },
  { kind: "asset", src: "/goldfishes/assets/company-logos/asml.svg" },
  ...
  { kind: "asset", src: "/goldfishes/assets/company-logos/oracle.svg" },
  { kind: "asset", src: "/goldfishes/assets/company-logos/salesforce.svg" },
  { kind: "asset", src: "/goldfishes/assets/company-logos/adobe.svg" },
  { kind: "asset", src: "/goldfishes/assets/company-logos/ibm.svg" },
  { kind: "asset", src: "/goldfishes/assets/company-logos/micron.svg" },
  { kind: "asset", src: "/goldfishes/assets/company-logos/servicenow.svg" },
